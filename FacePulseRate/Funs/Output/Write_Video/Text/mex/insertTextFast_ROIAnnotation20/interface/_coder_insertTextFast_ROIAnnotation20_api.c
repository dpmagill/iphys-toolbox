 ...
 *
 * _coder_insertTextFast_ROIAnnotation20_api.c
 *
 * Code generation for function '_coder_insertTextFast_ROIAnnotation20_api'
 *
 */
...
static const int32_T iv1[3] = { 45, 800, 3 };
...
static uint8_T (*emlrt_marshallIn(const mxArray *VidFrameCrop, const char_T
  *identifier))[108000];
static void emlrt_marshallOut(const uint8_T u[108000], const mxArray *y);
  ...
  *msgId))[108000]
{
  ...
  emlrtCheckBuiltInR2012b(emlrtRootTLSGlobal, msgId, src, "uint8", false, 3U,
    iv1);
  ret = (uint8_T (*)[108000])emlrtMxGetData(src);
...
void insertTextFast_ROIAnnotation20_api(const mxArray * const prhs[2], int32_T
  nlhs, const mxArray *plhs[1])
{
  const mxArray *prhs_copy_idx_0;
  uint8_T (*VidFrameCrop)[108000];
  ...
  insertTextFast_ROIAnnotation20(*VidFrameCrop, Text_data, Text_size);
...
/* End of code generation (_coder_insertTextFast_ROIAnnotation20_api.c) */
