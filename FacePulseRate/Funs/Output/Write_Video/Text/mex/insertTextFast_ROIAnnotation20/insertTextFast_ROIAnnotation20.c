 ...
 *
 * insertTextFast_ROIAnnotation20.c
 *
 * Code generation for function 'insertTextFast_ROIAnnotation20'
 *
 */
...
void insertTextFast_ROIAnnotation20(uint8_T VidFrameCrop[108000], const char_T
  Text_data[], const int32_T Text_size[2])
{
  ...
  /* insertTextFast_ROIAnnotation20   Code generation for function insertText for an image cropped to */
  /*                                  the size of the ROI annotation with font size 20.                              */
  /*  */
  ...
  /*        (insertTextFast_ROIAnnotation20_mex.mexw64) only compatible on Windows platforms.  */
  ...
  /* For variable 'Text', set a bound on the length of text to prevent dynamic memory allocation, */
  ...
  /*  [X, Y] coordinates: bottom-left (as specified by argument AnchorPoint) of indexed area */
  ...
  endC = text[0].f1.size[0] * text[0].f1.size[1];
  for (endR = 0; endR < endC; endR++) {
  ...
  if (text[0].f1.size[1] != 0) {
    ...
    getTextboxWidthHeight(thisTextU16_data, thisTextU16_size, &endC, &endR);
    tbWidth = endC - 1;
    ...
    if ((endR >= 1) && (endC >= 1)) {
      ...
      for (tbWidth = 0; tbWidth < 3; tbWidth++) {
        for (c = tbTopLeftX; c <= endC; c++) {
          for (r = startR - 21; r <= endR; r++) {
            /* {    */
            /* end */
            /*   */
            ...
            /* end */
            /* } */
            tmp11 = (uint8_T)(0.6 * (real_T)boxColor[tbWidth] + 0.5);
            ...
            /* end */
            /* } */
            tmp22 = (uint8_T)(0.4 * (real_T)VidFrameCrop[((r + 45 * (c - 1)) +
              36000 * tbWidth) - 1] + 0.5);
            VidFrameCrop[((r + 45 * (c - 1)) + 36000 * tbWidth) - 1] = (uint8_T)
    ...
    insertGlyphs(VidFrameCrop, thisTextU16_data, thisTextU16_size, position[0] +
                 11, tbTopLeftY - 10);
  }
  ...
  /* (insertTextFast_ROIAnnotation20_mex) of the function. */
  /* { */
  /*  */
  ...
  /*  */
  /* VidFrameCropCode = zeros(45, 800, 3, 'uint8'); %uint8 */
  /*  */
  /*  */
  ...
  /*  */
  /* codegen insertTextFast_ROIAnnotation20.m -report -config cfg -args {VidFrameCropCode, TextCode} */
  /*  */
  /* } */
}

/* End of code generation (insertTextFast_ROIAnnotation20.c) */
