 ...
 *
 * _coder_insertTextFast_PulseRate13_api.c
 *
 * Code generation for function '_coder_insertTextFast_PulseRate13_api'
 *
 */
...
static const int32_T iv1[3] = { 29, 575, 3 };
...
static uint8_T (*emlrt_marshallIn(const mxArray *VidFrameCrop, const char_T
  *identifier))[50025];
static void emlrt_marshallOut(const uint8_T u[50025], const mxArray *y);
  ...
  *msgId))[50025]
{
  ...
  emlrtCheckBuiltInR2012b(emlrtRootTLSGlobal, msgId, src, "uint8", false, 3U,
    iv1);
  ret = (uint8_T (*)[50025])emlrtMxGetData(src);
...
void insertTextFast_PulseRate13_api(const mxArray * const prhs[2], int32_T nlhs,
  const mxArray *plhs[1])
{
  const mxArray *prhs_copy_idx_0;
  uint8_T (*VidFrameCrop)[50025];
  ...
  insertTextFast_PulseRate13(*VidFrameCrop, Text_data, Text_size);
...
/* End of code generation (_coder_insertTextFast_PulseRate13_api.c) */
