function [VidFrameCrop] = insertTextFast_PulseRate20(VidFrameCrop, Text) %#codegen
%insertTextFast_PulseRate20   Code generation for function insertText for an image cropped to the
%                             size of the pulse rate annotation with font size 20.                             
%
...
VidFrameCrop = ...
    insertTextNoValidation( ...
        ...
        Text,                        ... text
        'Font', 'Consolas',          ... font type; must be compile-time constant
