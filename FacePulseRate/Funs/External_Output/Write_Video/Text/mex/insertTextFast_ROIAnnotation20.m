function [VidFrameCrop] = insertTextFast_ROIAnnotation20(VidFrameCrop, Text) %#codegen
...
VidFrameCrop = ...
    insertTextNoValidation( ...
        VidFrameCrop,                ...
        [1, 45],                     ... [X, Y] coordinates: bottom-left (as specified by argument AnchorPoint) of indexed area
                                     ... Y-coordinate should equal TextBoxMaxRowSize
        Text,                        ... text
        'Font', 'Consolas',          ... font type
        'FontSize', 20,              ... font size; must be compile-time constant
