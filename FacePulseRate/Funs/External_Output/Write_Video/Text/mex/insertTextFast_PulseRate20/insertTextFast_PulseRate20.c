 ...
 *
 * insertTextFast_PulseRate20.c
 *
 * Code generation for function 'insertTextFast_PulseRate20'
 *
 */
...
void insertTextFast_PulseRate20(uint8_T VidFrameCrop[114750], const char_T
  Text_data[], const int32_T Text_size[2])
{
  ...
  /* insertTextFast_PulseRate20   Code generation for function insertText for an image cropped */
  /*                              to the size of the pulse rate annotation with font size 20.                              */
  /*  */
  ...
  /*        (insertTextFast_PulseRate20_mex.mexw64) only compatible on Windows platforms.  */
        ...
        for (c = 1; c <= endC; c++) {
          for (r = 1; r <= endR; r++) {
            ...
            tmp22 = (uint8_T)(0.4 * (real_T)VidFrameCrop[((r + 45 * (c - 1)) +
              38250 * loop_ub) - 1] + 0.5);
            VidFrameCrop[((r + 45 * (c - 1)) + 38250 * loop_ub) - 1] = (uint8_T)
  ...
  /* (insertTextFast_PulseRate20_mex) of the function. */
  /* { */
  /*  */
  ...
  /*  */
  /* VidFrameCropCode   = zeros(45, 850, 3, 'uint8'); %uint8 */
  /*  */
  /*  */
  ...
  /*  */
  /* codegen insertTextFast_PulseRate20.m -report -config cfg -args {VidFrameCropCode, TextCode} */
  /*  */
  /* } */
}

/* End of code generation (insertTextFast_PulseRate20.c) */
