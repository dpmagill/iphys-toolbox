 ...
 *
 * _coder_insertTextFast_ROIAnnotation13_api.c
 *
 * Code generation for function '_coder_insertTextFast_ROIAnnotation13_api'
 *
 */
...
static const int32_T iv1[3] = { 29, 550, 3 };
...
static uint8_T (*emlrt_marshallIn(const mxArray *VidFrameCrop, const char_T
  *identifier))[47850];
static void emlrt_marshallOut(const uint8_T u[47850], const mxArray *y);
  ...
  *msgId))[47850]
{
  ...
  emlrtCheckBuiltInR2012b(emlrtRootTLSGlobal, msgId, src, "uint8", false, 3U,
    iv1);
  ret = (uint8_T (*)[47850])emlrtMxGetData(src);
...
void insertTextFast_ROIAnnotation13_api(const mxArray * const prhs[2], int32_T
  nlhs, const mxArray *plhs[1])
{
  const mxArray *prhs_copy_idx_0;
  uint8_T (*VidFrameCrop)[47850];
  ...
  insertTextFast_ROIAnnotation13(*VidFrameCrop, Text_data, Text_size);
...
/* End of code generation (_coder_insertTextFast_ROIAnnotation13_api.c) */
