...
[Video_InputFile, EndTimeSpecified, EndTime, PulseRateControlLuminance, ...
 UseCompiledFunctionsTF] = ...
    ValidateAndConfigure_Validate(Video_InputFile, StartTime, EndTime, ROIMinWidthProportion, ...
        ROIMinHeightProportion, ROISpecifyByArgument, ROIIgnoreByArgument, PulseRateTF, ...
        PulseRateWindowDurationSec, PulseRateExternallyMeasured, PulseRateBlockTimestamps, ...                 
