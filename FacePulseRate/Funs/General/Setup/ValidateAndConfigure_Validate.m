...
%Calculation of pulse rate enabled but video duration or window duration less than 2 seconds:

%2 seconds is the minimum due to constraints of the CHROM_DEHAAN algorithm.
...
if PulseRateTF   
    ...
    if EndTime - StartTime < 2
        ...
        ME = ...
            MException( ...
                'Component:Argument', ...
                ['Error: To calculate pulse rate, the video duration must be greater than or', ...
                 'equal to 2 seconds.'] ...
            );
    ...
    %Note: this check is also conducted by the argument block to function FacePulseRate.
    if PulseRateWindowDurationSec < 2

        ME = ...
            MException( ...
                'Component:Argument', ...
                ['Error: To calculate pulse rate, PulseRateWindowDurationSec must be greater', ...
