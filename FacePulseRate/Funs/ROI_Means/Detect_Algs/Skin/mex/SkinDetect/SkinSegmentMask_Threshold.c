...
static void ApplyRangeThreshold(emlrtCTX aTLS, const emxArray_uint8_T
  *RBounded_Uint8, int16_T RangeNeighborhoodWidth, uint8_T RangeThreshold,
...
#pragma omp parallel \
 ...
 private(r,tmp_size,b_tmp_size,i1,b_loop_ub,emlrtJBEnviron) \
 firstprivate(aTLS,emlrtHadParallelError)

  {
    ...
    if (setjmp(emlrtJBEnviron) == 0) {
      emxInit_boolean_T(aTLS, &r, 2, true);
    } else {
...
#pragma omp for nowait
      ...
      if (setjmp(emlrtJBEnviron) == 0) {
        ...
        if (i + 1 == 1) {
          ...
          c_SkinSegmentMask_Threshold_Col(RBounded_Uint8, GBounded_Uint8,
            ...
            DontUseTailoredTF, YCbCrThresholds_Generic, YCbCrThresholds_Tailored,
            HSThresholds_Generic, HSThresholds_Tailored, r, ParCell1[0].f1[0].f1,
            ParCell1[0].f1[1].f1, ParCell1[0].f1[2].f1, tmp_size, b_tmp_size);
          i1 = ParCell2[0].f1->size[0] * ParCell2[0].f1->size[1];
          ParCell2[0].f1->size[0] = r->size[0];
          ParCell2[0].f1->size[1] = r->size[1];
          emxEnsureCapacity_boolean_T(ParCell2[0].f1, i1);
          b_loop_ub = r->size[0] * r->size[1];
          for (i1 = 0; i1 < b_loop_ub; i1++) {
            ParCell2[0].f1->data[i1] = r->data[i1];
          }

          ParCell1[0].f1[3].f1->size[0] = 0;
          ParCell1[0].f1[3].f1->size[1] = 0;
          ParCell1[0].f1[4].f1->size[0] = 0;
          ParCell1[0].f1[4].f1->size[1] = 0;
          ...
          ApplyRangeThreshold(aTLS, RBounded_Uint8, RangeNeighborhoodWidth,
                              RangeThreshold, ParCell2[1].f1);
  ...
  loop_ub = ParCell1[0].f1[0].f1->size[0] * ParCell1[0].f1[0].f1->size[1];
  for (b_i = 0; b_i < loop_ub; b_i++) {
    YBounded_Single->data[b_i] = ParCell1[0].f1[0].f1->data[b_i];
  }
  ...
  loop_ub = ParCell1[0].f1[1].f1->size[0] * ParCell1[0].f1[1].f1->size[1];
  for (b_i = 0; b_i < loop_ub; b_i++) {
    CbBounded_Single->data[b_i] = ParCell1[0].f1[1].f1->data[b_i];
  }
  ...
  loop_ub = ParCell1[0].f1[2].f1->size[0] * ParCell1[0].f1[2].f1->size[1];
  for (b_i = 0; b_i < loop_ub; b_i++) {
    CrBounded_Single->data[b_i] = ParCell1[0].f1[2].f1->data[b_i];
  }

  HBounded_Single_size[0] = ParCell1[0].f1[3].f1->size[0];
  HBounded_Single_size[1] = ParCell1[0].f1[3].f1->size[1];
  loop_ub = ParCell1[0].f1[3].f1->size[0] * ParCell1[0].f1[3].f1->size[1];
  for (b_i = 0; b_i < loop_ub; b_i++) {
    HBounded_Single_data[b_i] = ParCell1[0].f1[3].f1->data[b_i];
  }

  SBounded_Single_size[0] = ParCell1[0].f1[4].f1->size[0];
  SBounded_Single_size[1] = ParCell1[0].f1[4].f1->size[1];
  loop_ub = ParCell1[0].f1[4].f1->size[0] * ParCell1[0].f1[4].f1->size[1];
  for (b_i = 0; b_i < loop_ub; b_i++) {
    SBounded_Single_data[b_i] = ParCell1[0].f1[4].f1->data[b_i];
  }
  ...
  for (b_i = 0; b_i < loop_ub; b_i++) {
    c_loop_ub = ParCell2[1].f1->size[0];
    for (i2 = 0; i2 < c_loop_ub; i2++) {
      IsSkinMask_Range->data[i2 + IsSkinMask_Range->size[0] * b_i] = ParCell2[1]
        .f1->data[i2 + ParCell2[1].f1->size[0] * b_i];
    }
  }
  ...
  for (loop_ub = 0; loop_ub < NElements_Matrix; loop_ub++) {
    if (IsSkinMask->data[loop_ub] && ParCell2[1].f1->data[loop_ub]) {
...
#pragma omp parallel \
 num_threads(emlrtAllocRegionTLSs(aTLS, omp_in_parallel(), omp_get_max_threads(), 2)) \
 private(tmp_size,b_tmp_size,c_tmp_size,d_tmp_size,e_tmp_size,emlrtJBEnviron) \
 firstprivate(emlrtHadParallelError,aTLS)
...
#pragma omp for nowait
    ...
    for (i = 0; i < 2; i++) {
      ...
      if (setjmp(emlrtJBEnviron) == 0) {
        ...
        if (i + 1 == 1) {
          ...
          /*  H channel matrix */
          /*  S channel matrix */
          d_SkinSegmentMask_Threshold_Col(RBounded_Uint8, GBounded_Uint8,
            BBounded_Uint8, NRows_Matrix, NCols_Matrix, NElements_Matrix,
            DontUseTailoredTF, YCbCrThresholds_Generic, YCbCrThresholds_Tailored,
            HSThresholds_Generic, HSThresholds_Tailored, ParCell2[0].f1,
            tmp_size, b_tmp_size, c_tmp_size, d_tmp_size, e_tmp_size);
          ParCell1[0].f1[0].f1->size[0] = 0;
          ParCell1[0].f1[0].f1->size[1] = 0;
          ParCell1[0].f1[1].f1->size[0] = 0;
          ParCell1[0].f1[1].f1->size[1] = 0;
          ParCell1[0].f1[2].f1->size[0] = 0;
          ParCell1[0].f1[2].f1->size[1] = 0;
          ParCell1[0].f1[3].f1->size[0] = 0;
          ParCell1[0].f1[3].f1->size[1] = 0;
          ParCell1[0].f1[4].f1->size[0] = 0;
          ParCell1[0].f1[4].f1->size[1] = 0;
  ...
  /* Extract results from parallel operations: */
  YBounded_Single_size[0] = ParCell1[0].f1[0].f1->size[0];
  YBounded_Single_size[1] = ParCell1[0].f1[0].f1->size[1];
  loop_ub = ParCell1[0].f1[0].f1->size[0] * ParCell1[0].f1[0].f1->size[1];
  for (b_i = 0; b_i < loop_ub; b_i++) {
    YBounded_Single_data[b_i] = ParCell1[0].f1[0].f1->data[b_i];
  }

  CbBounded_Single_size[0] = ParCell1[0].f1[1].f1->size[0];
  CbBounded_Single_size[1] = ParCell1[0].f1[1].f1->size[1];
  loop_ub = ParCell1[0].f1[1].f1->size[0] * ParCell1[0].f1[1].f1->size[1];
  for (b_i = 0; b_i < loop_ub; b_i++) {
    CbBounded_Single_data[b_i] = ParCell1[0].f1[1].f1->data[b_i];
  }

  CrBounded_Single_size[0] = ParCell1[0].f1[2].f1->size[0];
  CrBounded_Single_size[1] = ParCell1[0].f1[2].f1->size[1];
  loop_ub = ParCell1[0].f1[2].f1->size[0] * ParCell1[0].f1[2].f1->size[1];
  for (b_i = 0; b_i < loop_ub; b_i++) {
    CrBounded_Single_data[b_i] = ParCell1[0].f1[2].f1->data[b_i];
  }
  ...
  for (b_i = 0; b_i < loop_ub; b_i++) {
    ...
    for (i1 = 0; i1 < b_loop_ub; i1++) {
      IsSkinMask_Range->data[i1 + IsSkinMask_Range->size[0] * b_i] = ParCell2[1]
        .f1->data[i1 + ParCell2[1].f1->size[0] * b_i];
    }
  }
