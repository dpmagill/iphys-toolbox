...
void SkinSegmentMask_Threshold(emlrtCTX aTLS, const emxArray_uint8_T
  *RBounded_Uint8, const emxArray_uint8_T *GBounded_Uint8, const
  ...
  YCbCrThresholds_Generic[7], const real32_T HSThresholds_Generic[2], int16_T
...
#pragma omp parallel \
 ...
 private(b_RBounded_Uint8,r,r1,r2,r3,r4,i2,c_loop_ub,emlrtJBEnviron) \
 firstprivate(aTLS,emlrtHadParallelError)

    {
      ...
      if (setjmp(emlrtJBEnviron) == 0) {
        ...
        emxInit_real32_T(aTLS, &r, 2, true);
        emxInit_real32_T(aTLS, &r1, 2, true);
        emxInit_real32_T(aTLS, &r2, 2, true);
        emxInit_real32_T(aTLS, &r3, 2, true);
        emxInit_real32_T(aTLS, &r4, 2, true);
      } else {
...
#pragma omp for nowait
      ...
      for (i = 0; i < 2; i++) {
        ...
        if (setjmp(emlrtJBEnviron) == 0) {
          ...
          if (i + 1 == 1) {
            ...
            r4->size[0] = YBounded_Single->size[0];
            r4->size[1] = YBounded_Single->size[1];
            emxEnsureCapacity_real32_T(r4, i2);
            c_loop_ub = YBounded_Single->size[0] * YBounded_Single->size[1];
            for (i2 = 0; i2 < c_loop_ub; i2++) {
              r4->data[i2] = YBounded_Single->data[i2];
            }

            i2 = r3->size[0] * r3->size[1];
            r3->size[0] = CbBounded_Single->size[0];
            r3->size[1] = CbBounded_Single->size[1];
            emxEnsureCapacity_real32_T(r3, i2);
            c_loop_ub = CbBounded_Single->size[0] * CbBounded_Single->size[1];
            for (i2 = 0; i2 < c_loop_ub; i2++) {
              r3->data[i2] = CbBounded_Single->data[i2];
            }

            i2 = r2->size[0] * r2->size[1];
            r2->size[0] = CrBounded_Single->size[0];
            r2->size[1] = CrBounded_Single->size[1];
            emxEnsureCapacity_real32_T(r2, i2);
            c_loop_ub = CrBounded_Single->size[0] * CrBounded_Single->size[1];
            for (i2 = 0; i2 < c_loop_ub; i2++) {
              r2->data[i2] = CrBounded_Single->data[i2];
            }

            i2 = r1->size[0] * r1->size[1];
            r1->size[0] = HBounded_Single->size[0];
            r1->size[1] = HBounded_Single->size[1];
            emxEnsureCapacity_real32_T(r1, i2);
            c_loop_ub = HBounded_Single->size[0] * HBounded_Single->size[1];
            for (i2 = 0; i2 < c_loop_ub; i2++) {
              r1->data[i2] = HBounded_Single->data[i2];
            }

            i2 = r->size[0] * r->size[1];
            r->size[0] = SBounded_Single->size[0];
            r->size[1] = SBounded_Single->size[1];
            emxEnsureCapacity_real32_T(r, i2);
            c_loop_ub = SBounded_Single->size[0] * SBounded_Single->size[1];
            for (i2 = 0; i2 < c_loop_ub; i2++) {
              r->data[i2] = SBounded_Single->data[i2];
            }

            c_SkinSegmentMask_Threshold_Col(RBounded_Uint8, GBounded_Uint8,
              BBounded_Uint8, r4, r3, r2, r1, r, NRows_Matrix, NCols_Matrix,
              NElements_Matrix, YCbCrThresholds_Generic, HSThresholds_Generic,
              UseLinIdxTF, XOffset, YOffset, ParCell2[0].f1);
            ParCell1[0].f1[0].f1.size[0] = r4->size[0];
            ParCell1[0].f1[0].f1.size[1] = r4->size[1];
            c_loop_ub = r4->size[0] * r4->size[1];
            for (i2 = 0; i2 < c_loop_ub; i2++) {
              ParCell1[0].f1[0].f1.data[i2] = r4->data[i2];
            }

            ParCell1[0].f1[1].f1.size[0] = r3->size[0];
            ParCell1[0].f1[1].f1.size[1] = r3->size[1];
            c_loop_ub = r3->size[0] * r3->size[1];
            for (i2 = 0; i2 < c_loop_ub; i2++) {
              ParCell1[0].f1[1].f1.data[i2] = r3->data[i2];
            }

            ParCell1[0].f1[2].f1.size[0] = r2->size[0];
            ParCell1[0].f1[2].f1.size[1] = r2->size[1];
            c_loop_ub = r2->size[0] * r2->size[1];
            for (i2 = 0; i2 < c_loop_ub; i2++) {
              ParCell1[0].f1[2].f1.data[i2] = r2->data[i2];
            }

            ParCell1[0].f1[3].f1.size[0] = r1->size[0];
            ParCell1[0].f1[3].f1.size[1] = r1->size[1];
            c_loop_ub = r1->size[0] * r1->size[1];
            for (i2 = 0; i2 < c_loop_ub; i2++) {
              ParCell1[0].f1[3].f1.data[i2] = r1->data[i2];
            }

            ParCell1[0].f1[4].f1.size[0] = r->size[0];
            ParCell1[0].f1[4].f1.size[1] = r->size[1];
            c_loop_ub = r->size[0] * r->size[1];
            for (i2 = 0; i2 < c_loop_ub; i2++) {
              ParCell1[0].f1[4].f1.data[i2] = r->data[i2];
            }
      ...
      if (!emlrtHadParallelError) {
        emlrtHeapReferenceStackLeaveScope(aTLS, 6);
        emxFree_real32_T(&r4);
        emxFree_real32_T(&r3);
        emxFree_real32_T(&r2);
        emxFree_real32_T(&r1);
    ...
    c_SkinSegmentMask_Threshold_Col(RBounded_Uint8, GBounded_Uint8,
      ...
      NElements_Matrix, YCbCrThresholds_Generic, HSThresholds_Generic,
      UseLinIdxTF, XOffset, YOffset, IsSkinMask);
  }
