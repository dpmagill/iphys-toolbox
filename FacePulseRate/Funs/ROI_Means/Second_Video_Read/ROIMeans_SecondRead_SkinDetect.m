...
%Note: ROIMeans_SecondRead_SetBoundingBox is a custom function located within folder 
%'FacePulseRate'.
[BoundingBoxSkin, IncreaseSkinBBoxFactorStartIdx] = ...
    ROIMeans_SecondRead_SetBoundingBox(i, IncreaseSkinBBoxFactorStartIdx, ROI, HasROI_TF, ...
        ROIGeneralConfig, SkinDetectConfig, VideoReadConfig);
...
%display option is enabled, in which case flag OutputConfig.WriteVideoDetailedDiagnosticsTF will be  
%true. By default, it is false. Flag OutputConfig.WriteVideoDetailedDiagnosticsTF is set by   
%function ValidateAndConfigure_InternalFlags.
