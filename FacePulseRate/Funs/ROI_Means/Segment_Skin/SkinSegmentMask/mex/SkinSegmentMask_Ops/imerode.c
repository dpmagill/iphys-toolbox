               ...
               B)
{
  ...
  sizeB[1] = Apad->size[1];
  nsizeT[1] = 1.0;
  erode_packed_uint32(&Apad->data[0], sizeB, 2.0, nhood, nsizeT, 2.0, varargin_2,
                      &b_B->data[0], true);
  i = Apad->size[0] * Apad->size[1];
  ...
  sizeB[1] = Apad->size[1];
  nsizeT[1] = 3.0;
  erode_packed_uint32(&Apad->data[0], sizeB, 2.0, bv, nsizeT, 2.0, varargin_2,
                      &b_B->data[0], true);
  i = Apad->size[0] * Apad->size[1];
  Apad->size[0] = b_B->size[0];
  Apad->size[1] = b_B->size[1];
  ...
  sizeB[1] = Apad->size[1];
  nsizeT[1] = 3.0;
  erode_packed_uint32(&Apad->data[0], sizeB, 2.0, bv1, nsizeT, 2.0, varargin_2,
                      &b_B->data[0], true);
  i = Apad->size[0] * Apad->size[1];
  Apad->size[0] = b_B->size[0];
  Apad->size[1] = b_B->size[1];
  ...
  sizeB[1] = Apad->size[1];
  nsizeT[1] = 5.0;
  erode_packed_uint32(&Apad->data[0], sizeB, 2.0, bv2, nsizeT, 2.0, varargin_2,
                      &b_B->data[0], true);
  i = Apad->size[0] * Apad->size[1];
  Apad->size[0] = b_B->size[0];
  Apad->size[1] = b_B->size[1];
  ...
  sizeB[1] = Apad->size[1];
  nsizeT[1] = 3.0;
  erode_packed_uint32(&Apad->data[0], sizeB, 2.0, bv3, nsizeT, 2.0, varargin_2,
                      &b_B->data[0], true);
  i = Apad->size[0] * Apad->size[1];
  Apad->size[0] = b_B->size[0];
  Apad->size[1] = b_B->size[1];
  ...
  sizeB[1] = Apad->size[1];
  nsizeT[1] = 3.0;
  erode_packed_uint32(&Apad->data[0], sizeB, 2.0, bv4, nsizeT, 2.0, varargin_2,
                      &b_B->data[0], true);
  i = Apad->size[0] * Apad->size[1];
  Apad->size[0] = b_B->size[0];
  Apad->size[1] = b_B->size[1];
  ...
  sizeB[1] = Apad->size[1];
  nsizeT[1] = 7.0;
  erode_packed_uint32(&Apad->data[0], sizeB, 2.0, b_nhood, nsizeT, 2.0,
...
void imerode(const emxArray_uint32_T *A, real_T varargin_2, emxArray_uint32_T *B)
{
  ...
  sizeB[1] = Apad->size[1];
  nsizeT[1] = 9.0;
  erode_packed_uint32(&Apad->data[0], sizeB, 2.0, c_nhood, nsizeT, 2.0,
                      varargin_2, &b_B->data[0], true);
  i = Apad->size[0] * Apad->size[1];
  Apad->size[0] = b_B->size[0];
  Apad->size[1] = b_B->size[1];
