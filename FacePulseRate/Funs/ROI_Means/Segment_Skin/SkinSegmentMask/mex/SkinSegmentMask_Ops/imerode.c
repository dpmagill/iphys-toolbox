               ...
               B)
{
  ...
  setPackedFillBits(b_A, varargin_2);
  ...
  if ((b_A->size[0] == 0) || (b_A->size[1] == 0)) {
    ...
    for (pad_ul_idx_0 = 0; pad_ul_idx_0 < 5; pad_ul_idx_0++) {
      ...
      for (pad_ul_idx_1 = 0; pad_ul_idx_1 < i; pad_ul_idx_1++) {
        Apadpre->data[pad_ul_idx_1 + Apadpre->size[0] * pad_ul_idx_0] =
          MAX_uint32_T;
      }
    }
    ...
    for (pad_ul_idx_0 = 6; pad_ul_idx_0 <= i; pad_ul_idx_0++) {
      Apadpre->data[Apadpre->size[0] * (pad_ul_idx_0 - 1)] = MAX_uint32_T;
    }
  ...
  for (pad_ul_idx_0 = i; pad_ul_idx_0 <= i1; pad_ul_idx_0++) {
    ...
    for (pad_ul_idx_1 = 0; pad_ul_idx_1 < i2; pad_ul_idx_1++) {
      Apad->data[pad_ul_idx_1 + Apad->size[0] * (pad_ul_idx_0 - 1)] =
        MAX_uint32_T;
    }
  }
  ...
  sizeB[1] = Apad->size[1];
  nsizeT[1] = 1.0;
  erode_packed_uint32(&Apad->data[0], &sizeB[0], 2.0, &nhood[0], &nsizeT[0], 2.0,
                      varargin_2, &b_B->data[0], true);
  i = Apad->size[0] * Apad->size[1];
  ...
  sizeB[1] = Apad->size[1];
  nsizeT[1] = 1.0;
  erode_packed_uint32(&Apad->data[0], &sizeB[0], 2.0, &b_nhood, &nsizeT[0], 2.0,
                      varargin_2, &b_B->data[0], true);
  i = Apad->size[0] * Apad->size[1];
  Apad->size[0] = b_B->size[0];
  Apad->size[1] = b_B->size[1];
  ...
  sizeB[1] = Apad->size[1];
  nsizeT[1] = 9.0;
  erode_packed_uint32(&Apad->data[0], &sizeB[0], 2.0, &c_nhood[0], &nsizeT[0],
                      2.0, varargin_2, &b_B->data[0], true);
  i = Apad->size[0] * Apad->size[1];
  Apad->size[0] = b_B->size[0];
  Apad->size[1] = b_B->size[1];
  emxEnsureCapacity_uint32_T(Apad, i);
               ...
               B)
{
  ...
  sizeB[1] = Apad->size[1];
  nsizeT[1] = 3.0;
  erode_packed_uint32(&Apad->data[0], &sizeB[0], 2.0, &bv[0], &nsizeT[0], 2.0,
                      varargin_2, &b_B->data[0], true);
  i = Apad->size[0] * Apad->size[1];
  Apad->size[0] = b_B->size[0];
  Apad->size[1] = b_B->size[1];
  ...
  sizeB[1] = Apad->size[1];
  nsizeT[1] = 3.0;
  erode_packed_uint32(&Apad->data[0], &sizeB[0], 2.0, &bv1[0], &nsizeT[0], 2.0,
                      varargin_2, &b_B->data[0], true);
  i = Apad->size[0] * Apad->size[1];
  Apad->size[0] = b_B->size[0];
  Apad->size[1] = b_B->size[1];
               ...
               B)
{
  ...
  sizeB[1] = Apad->size[1];
  nsizeT[1] = 3.0;
  erode_packed_uint32(&Apad->data[0], &sizeB[0], 2.0, &bv2[0], &nsizeT[0], 2.0,
                      varargin_2, &b_B->data[0], true);
  i = Apad->size[0] * Apad->size[1];
  Apad->size[0] = b_B->size[0];
  Apad->size[1] = b_B->size[1];
  ...
  sizeB[1] = Apad->size[1];
  nsizeT[1] = 5.0;
  erode_packed_uint32(&Apad->data[0], &sizeB[0], 2.0, &bv3[0], &nsizeT[0], 2.0,
                      varargin_2, &b_B->data[0], true);
  i = Apad->size[0] * Apad->size[1];
  Apad->size[0] = b_B->size[0];
  Apad->size[1] = b_B->size[1];
  ...
  sizeB[1] = Apad->size[1];
  nsizeT[1] = 3.0;
  erode_packed_uint32(&Apad->data[0], &sizeB[0], 2.0, &bv4[0], &nsizeT[0], 2.0,
                      varargin_2, &b_B->data[0], true);
  i = Apad->size[0] * Apad->size[1];
  Apad->size[0] = b_B->size[0];
  Apad->size[1] = b_B->size[1];
  ...
  sizeB[1] = Apad->size[1];
  nsizeT[1] = 7.0;
  erode_packed_uint32(&Apad->data[0], &sizeB[0], 2.0, &b_nhood[0], &nsizeT[0],
                      2.0, varargin_2, &b_B->data[0], true);
  i = Apad->size[0] * Apad->size[1];
  Apad->size[0] = b_B->size[0];
  Apad->size[1] = b_B->size[1];
...
void imerode(const emxArray_uint32_T *A, real_T varargin_2, emxArray_uint32_T *B)
{
  ...
  asizeT[1] = b_A->size[1];
  nsizeT[1] = 1.0;
  erode_packed_uint32(&b_A->data[0], &asizeT[0], 2.0, &nhood, &nsizeT[0], 2.0,
                      varargin_2, &b_B->data[0], true);
  i = B->size[0] * B->size[1];
  B->size[0] = b_B->size[0];
  B->size[1] = b_B->size[1];
  ...
  asizeT[1] = b_B->size[1];
  nsizeT[1] = 1.0;
  erode_packed_uint32(&b_B->data[0], &asizeT[0], 2.0, &nhood, &nsizeT[0], 2.0,
                      varargin_2, &c_B->data[0], true);
  i = B->size[0] * B->size[1];
  B->size[0] = c_B->size[0];
  B->size[1] = c_B->size[1];
  emxEnsureCapacity_uint32_T(B, i);
  ...
  asizeT[1] = c_B->size[1];
  nsizeT[1] = 1.0;
  erode_packed_uint32(&c_B->data[0], &asizeT[0], 2.0, &nhood, &nsizeT[0], 2.0,
                      varargin_2, &b_B->data[0], true);
  i = B->size[0] * B->size[1];
  B->size[0] = b_B->size[0];
  B->size[1] = b_B->size[1];
  ...
  asizeT[1] = c_B->size[1];
  nsizeT[1] = 7.0;
  erode_packed_uint32(&c_B->data[0], &asizeT[0], 2.0, &b_nhood[0], &nsizeT[0],
                      2.0, varargin_2, &b_B->data[0], true);
  i = B->size[0] * B->size[1];
  B->size[0] = b_B->size[0];
  B->size[1] = b_B->size[1];
  ...
  asizeT[1] = b_B->size[1];
  nsizeT[1] = 1.0;
  erode_packed_uint32(&b_B->data[0], &asizeT[0], 2.0, &b_nhood[0], &nsizeT[0],
                      2.0, varargin_2, &c_B->data[0], true);
  i = B->size[0] * B->size[1];
  B->size[0] = c_B->size[0];
  B->size[1] = c_B->size[1];
  emxEnsureCapacity_uint32_T(B, i);
