 ...
 *
 * insertTextFast_Font16LT.c
 *
 * Code generation for function 'insertTextFast_Font16LT'
 *
 */
...
void insertTextFast_Font16LT(emxArray_uint8_T *VidFrame, const emxArray_int16_T *
  ...
  const real_T BoxColor[3])
{
  ...
  /* insertTextFast_Font16LT   Code-generation for function insertText using font size of 16 and */
  /*                           positioned such that the [X, Y] coordinates are to the left-top relative  */
  /*                           to the text.     */
  /*                                        */
  /*     Helper function to function FacePulseRate.  */
  /*     Within function FacePulseRate, called by functions WriteFaceVideo_SkinDetectDiagnosis and */
  ...
  /*     (insertTextFast_Font16LT_mex.mexw64) only compatible on Windows platforms. */
  ...
  if (!isEmpty) {
    ...
    for (ii = 0; ii < i; ii++) {
      ...
      if (thisTextU16->size[1] != 0) {
        ...
        insertGlyphs(VidFrame, thisTextU16, TextXY->data[ii] + 5, TextXY->
                     data[ii + TextXY->size[0]] + 5, b_colorRGB);
      }
    }
  ...
  /* (insertTextFast_Font16LT_mex) of the function. */
  /* { */
  /*  */
  ...
  /*  */
  /* codegen insertTextFast_Font16LT.m -report -config cfg -args {VidFrameCode, TextXYCode, TextCode, textColorCode, BoxColorCode} */
  /*  */
  /* } */
  emlrtHeapReferenceStackLeaveFcnR2012b(emlrtRootTLSGlobal);
}

/* End of code generation (insertTextFast_Font16LT.c) */
