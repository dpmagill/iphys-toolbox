 ...
 *
 * _coder_insertTextFast_Font13LT_api.c
 *
 * Code generation for function '_coder_insertTextFast_Font13LT_api'
 *
 */
  ...
  msgId))[3]
{
  ...
  void insertTextFast_Font13LT_api(const mxArray * const prhs[5], int32_T nlhs,
  const mxArray *plhs[1])
{
  ...
  insertTextFast_Font13LT(VidFrame, TextXY, Text, textColor, *BoxColor);
...
/* End of code generation (_coder_insertTextFast_Font13LT_api.c) */
