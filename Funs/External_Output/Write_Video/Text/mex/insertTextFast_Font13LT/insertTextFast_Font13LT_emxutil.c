 ...
 *
 * insertTextFast_Font13LT_emxutil.c
 *
 * Code generation for function 'insertTextFast_Font13LT_emxutil'
 *
 */
...
static void emxInitStruct_cell_wrap_0(cell_wrap_0 *pStruct, boolean_T doPush)
{
  emxInit_char_T(&pStruct->f1, 2, doPush);
}
...
/* End of code generation (insertTextFast_Font13LT_emxutil.c) */
