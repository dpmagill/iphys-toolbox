 ...
 *
 * ROIMeans_FirstRead_CollectSkinColorSamples_types.h
 *
 * Code generation for function 'ROIMeans_FirstRead_CollectSkinColorSamples_types'
 *
 */
...
/* End of code generation (ROIMeans_FirstRead_CollectSkinColorSamples_types.h) */
